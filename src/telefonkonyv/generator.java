...
public class generator {
    ...
    public void generator(String fileName, ObservableList<szemely> data) {
        ...
        try {
            ...
            for (int i = 1; i <= data.size(); i++) {
                szemely actualSzemely = data.get(i - 1);
                
                table.addCell(""+i);
                table.addCell(actualSzemely.getLastName());
                table.addCell(actualSzemely.getFirstName());
                table.addCell(actualSzemely.getEmail());
            }
